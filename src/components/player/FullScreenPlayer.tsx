...
import { DotmSquare18 } from "../ui/loading-square";
...
function getThumbnailPosition(
  ...
  if ((!sb.templateUrl && !sb.url) || sb.count === 0 || sb.interval === 0)
    return null;
  const frameIndex = Math.max(
    0,
    Math.min(sb.count - 1, Math.floor(time / (sb.interval / 1000)))
  );
  ...
  const spriteUrl = sb.templateUrl
    ? sb.templateUrl.replace("$M", String(sheetIndex))
    : sb.url;
  return {
    spriteUrl,
...
export function FullScreenPlayer() {
      ...
      if (isPlaying) {
        syncIntervalRef.current = setInterval(() => {
          ...
          if (
            audio &&
            vid &&
            Math.abs(vid.currentTime - audio.currentTime) > 0.15
          ) {
  ...
  const detectionGroups = useMemo(() => {
    ...
    for (const d of detections) {
      ...
      if (
        last &&
        Math.abs(d.start_time_seconds - last.primary.start_time_seconds) <= 2
      ) {
  ...
  const handleProgressMouseMove = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      setHoverTime(
        Math.max(0, Math.min(duration, (x / rect.width) * duration))
      );
    },
    [duration]
  );
  ...
  useEffect(() => {
    ...
    const nextDetection = detections.find(
      (d) => d.start_time_seconds > currentTime
    );
  ...
  const upNextConcurrent = upNextDetection
    ? detections.filter(
        (d) =>
          d.id !== upNextDetection.id &&
          Math.abs(d.start_time_seconds - upNextDetection.start_time_seconds) <=
            2
      )
    : [];
  ...
  return (
    ...
    >
      ...
      >
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: isTheaterMode
                    ? "inset 0 0 0 1px hsl(var(--h3) / 0.3)"
                    : "none",
                }}
                onMouseEnter={(e) => {
                  if (!isTheaterMode) {
        ...
        <div
          className={
            isTheaterMode ? "absolute inset-0" : "flex-1 min-h-0 relative"
          }
        >
          ...
          <div
            ...
            style={{
              ...
              transition:
                "opacity 0.5s cubic-bezier(0.16, 1, 0.3, 1) 0.05s, transform 0.5s cubic-bezier(0.16, 1, 0.3, 1) 0.05s, filter 0.5s cubic-bezier(0.16, 1, 0.3, 1) 0.05s",
                  ...
                  style={
                    isTheaterMode
                      ? {
                          ...
                          boxShadow: "none",
                          background: "#000",
                          animation: theaterEntering
                            ? "theaterExpand 0.55s cubic-bezier(0.16, 1, 0.3, 1)"
                            : undefined,
                        }
                      : {
                          aspectRatio: "16 / 9",
                  ...
                  style={
                    isTheaterMode
                      ? {
                          ...
                          maxHeight: "min(480px, calc(100% - 200px))",
                        }
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: isTheaterMode
                        ? "12px 0 0 12px"
                        : "0 12px 12px 0",
                      boxShadow: showTracklist
                        ? "inset 0 0 0 1px rgba(255,255,255,0.06)"
                        : "none",
                      transition:
                        "width 0.5s cubic-bezier(0.16, 1, 0.3, 1), opacity 0.35s cubic-bezier(0.16, 1, 0.3, 1)",
                    }}
                  >
                    <div
                      ...
                      style={{
                        width: 300,
                        height: isTheaterMode ? undefined : "100%",
                        maxHeight: isTheaterMode ? "100%" : undefined,
                      }}
                    >
                      ...
                      <div className="flex-1 overflow-y-auto px-2 pb-2 min-h-0">
                        {detectionGroups.map((group) => {
                          ...
                          const isPrimaryActive =
                            currentDetections.some(
                              (d) => d.id === primaryDetection.id
                            ) || currentDetection?.id === primaryDetection.id;
                          const isPrimaryPlaying =
                            currentDetection?.id === primaryDetection.id;
                          ...
                          const primaryCover = primarySong?.cover_art_r2_key
                            ...
                            : primarySong?.cover_art_url ||
                              primarySong?.lastfm_album_art ||
                              null;
                          ...
                          return (
                            <div key={primaryDetection.id}>
                              ...
                              <button
                                ref={
                                  isPrimaryPlaying ? activeTrackRef : undefined
                                }
                                onClick={() =>
                                  seek(primaryDetection.start_time_seconds)
                                }
                              ...
                              >
                                ...
                                >
                                  {isPrimaryPlaying && isPlaying ? (
                                      ...
                                      <span className="flex gap-[2px] items-end h-2.5">
                                        <span
                                          ...
                                          style={{
                                            background: "hsl(var(--h3))",
                                            animation:
                                              "eq-bar-1 0.8s ease-in-out infinite",
                                          }}
                                        />
                                        <span
                                          className="w-[2px] rounded-sm"
                                          style={{
                                            background: "hsl(var(--h3))",
                                            animation:
                                              "eq-bar-2 0.6s ease-in-out infinite",
                                          }}
                                        />
                                        <span
                                          className="w-[2px] rounded-sm"
                                    ...
                                    formatTime(
                                      primaryDetection.start_time_seconds
                                    )
                                  )}
                                </span>
                              ...
                              {hasSecondaries && (
                                ...
                                >
                                  {group.secondaries.map((secondary) => {
                                    const isSecActive = currentDetections.some(
                                      (d) => d.id === secondary.id
                                    );
                                    const secondarySong = secondary.song;
                                    const secondaryCover =
                                      secondarySong?.cover_art_r2_key
                                        ? getSongCoverUrl(secondarySong.id)
                                        : secondarySong?.cover_art_url ||
                                          secondarySong?.lastfm_album_art ||
                                          null;
                                    ...
                                    return (
                                      <button
                                        key={secondary.id}
                                        onClick={() =>
                                          seek(secondary.start_time_seconds)
                                        }
                  ...
                  <button
                    ...
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.color = showTracklist
                        ? "rgba(255,255,255,0.6)"
                        : "rgba(255,255,255,0.3)")
                    }
          ...
          {isTheaterMode && (
            <div
              style={{
                ...
                width: 260,
                transition:
                  "top 0.65s cubic-bezier(0.34, 1.4, 0.64, 1), right 0.65s cubic-bezier(0.34, 1.4, 0.64, 1), box-shadow 0.4s ease",
                animation: nowPlayingFlash
                  ? "nowPlayingFlash 1.1s cubic-bezier(0.16, 1, 0.3, 1)"
                  : undefined,
              }}
            >
              {/* Now Playing row */}
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    animation: nowPlayingFlash
                      ? "coverPromote 0.7s cubic-bezier(0.16, 1, 0.3, 1)"
                      : undefined,
                  }}
                >
                  {songCover ? (
                    <img
                      ...
                      style={{
                        animation:
                          "coverFadeIn 0.45s cubic-bezier(0.16, 1, 0.3, 1)",
                      }}
                    />
                  ) : (
                    <div
                ...
                <div className="min-w-0 flex-1">
                  <p
                    style={{
                      ...
                      marginBottom: 2,
                      animation: nowPlayingFlash
                        ? "labelFlash 0.8s cubic-bezier(0.16, 1, 0.3, 1)"
                        : undefined,
                    }}
                  >
                    NOW PLAYING
                  ...
                  <p
                    ...
                    style={{
                      ...
                      lineHeight: 1.3,
                      animation: nowPlayingFlash
                        ? "nowPlayingTextPop 0.5s cubic-bezier(0.16, 1, 0.3, 1)"
                        : "titleSlideIn 0.3s ease-out",
                    }}
                  >
                  ...
                  {currentDetections.slice(1).map((d) => {
                    const dSong = d.song;
                    const dCover = dSong?.cover_art_r2_key
                      ? getSongCoverUrl(dSong.id)
                      : dSong?.cover_art_url || dSong?.lastfm_album_art || null;
                    return (
                      <div
                        key={d.id}
                        style={{
                ...
                >
                  ...
                  >
                    ...
                    {(() => {
                      ...
                      const upNextCover = upNextSong?.cover_art_r2_key
                        ? getSongCoverUrl(upNextSong.id)
                        : upNextSong?.cover_art_url ||
                          upNextSong?.lastfm_album_art ||
                          null;
                      const secondaryCover =
                        upNextConcurrent.length > 0
                          ? (() => {
                              const s = upNextConcurrent[0].song;
                              return s?.cover_art_r2_key
                                ? getSongCoverUrl(s.id)
                                : s?.cover_art_url ||
                                    s?.lastfm_album_art ||
                                    null;
                            })()
                      ...
                      return (
                        <div
                          style={{
                            position: "relative",
                            width: 26 + (upNextConcurrent.length > 0 ? 8 : 0),
                            height: 26,
                            flexShrink: 0,
                          }}
                        >
          ...
          {isTheaterMode && (
            <div
              style={{
                ...
                pointerEvents: showControls ? "auto" : "none",
                background:
                  "linear-gradient(to top, rgba(0,0,0,0.72) 0%, rgba(0,0,0,0.32) 60%, transparent 100%)",
                    ...
                    <div
                      ...
                      style={{
                        ...
                        left: Math.max(
                          0,
                          Math.min(
                            hoverBarWidth - thumbnailInfo.thumbWidth,
                        ...
                        <div
                          style={{
                            ...
                            backgroundSize: storyboard
                              ? `${
                                  storyboard.storyboardWidth *
                                  thumbnailInfo.thumbWidth
                                }px ${
                                  storyboard.storyboardHeight *
                                  thumbnailInfo.thumbHeight
                                }px`
                              : undefined,
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: "hsl(var(--h3))",
                        boxShadow: "0 4px 20px hsl(var(--h4) / 0.45)",
                      }}
                    >
                      {isPlaying ? (
                        <svg
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div
              ...
              style={{
                ...
                transition:
                  "opacity 0.4s cubic-bezier(0.16, 1, 0.3, 1), max-height 0.4s cubic-bezier(0.16, 1, 0.3, 1), transform 0.4s cubic-bezier(0.16, 1, 0.3, 1)",
              }}
            >
              {/* Mini cover — crossfade on track change */}
              <div
                className="relative w-10 h-10 shrink-0 rounded-lg overflow-hidden"
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <div className="flex items-center gap-6">
                ...
                <button
                  ...
                  style={{
                    background: "hsl(var(--h3))",
                    boxShadow: "0 4px 20px hsl(var(--h4) / 0.35)",
                  }}
                >
                  {isPlaying ? (
                    <svg
