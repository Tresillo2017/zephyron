            ...
            {showUserMenu && (
              ...
              >
                ...
                {[
                  ...
                  { to: '/app/request-set', label: 'Request a Set', icon: 'M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z' },
                  ...
                  { to: '/app/changelog', label: 'Changelog', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
                ].map((item) => (
                  <Link
                    key={item.to}
                    to={item.to}
                ...
                <div className="mt-2 pt-2">
                  <a
                    ...
                    onClick={() => setShowUserMenu(false)}
                    className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-text-muted hover:text-text-secondary hover:bg-surface-hover transition-colors no-underline"
                  >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
